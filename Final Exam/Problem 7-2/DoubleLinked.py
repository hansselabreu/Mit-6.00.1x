...
#Now assume that you have a working insert procedure.
#Starting with any Frob in a doubly linked list,
#we would like to find the "front" Frob, i.e.,
#the one whose name is closest to the beginning of the alphabet.
#Write a recursive function called findFront to do this.
#findFront should take as an argument any Frob that is part
